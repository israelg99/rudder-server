...
func (m *Repository) Suppress(userID, workspaceID, sourceID string) (bool, error) {
...
// Start is a no-op for the memory repository.
func (*Repository) Start(_ func() (io.Reader, error)) error {
	return nil
}
