...
*/
func getDSList(jd assertInterface, dbHandle dbOrTx, tablePrefix string) []dataSetT {
...
func mustGetAllTableNames(jd assertInterface, dbHandle dbOrTx) []string {
...
func getAllTableNames(dbHandle dbOrTx) ([]string, error) {
